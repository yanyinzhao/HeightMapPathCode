...
- Sur-SimQue-AdpC (baseline simplification algorithm that calculate the path passing on a point cloud)
- Sur-SimQue (baseline simplification algorithm that calculate the path passing on a TIN)
- Net-SimQue-AdpM (baseline simplification algorithm)
- Net-SimQue-AdpC (baseline simplification algorithm that calculate the path passing on a point cloud)
- Net-SimQue (baseline simplification algorithm that calculate the path passing on a TIN)
- Mes-SimQue-AdpM (baseline simplification algorithm)
- Mes-SimQue (baseline simplification algorithm that calculate the path passing on a point cloud)
- Mes-SimQue-AdpT (baseline simplification algorithm that calculate the path passing on a TIN)
...
- Unf-Que-AdpC (baseline shortest path query algorithm that calculate the path passing on a point cloud)
- Unf-Que (baseline shortest path query algorithm that calculate the path passing on a TIN)
- Ste-Que-AdpM (baseline shortest path query algorithm)
- Ste-Que-AdpC (baseline shortest path query algorithm that calculate the path passing on a point cloud)
- Ste-Que (baseline shortest path query algorithm that calculate the path passing on a TIN)
- Dij-Que-AdpM (baseline shortest path query algorithm)
- Dij-Que-AdpC (baseline shortest path query algorithm that calculate the path passing on a point cloud)
- Dij-Que (baseline shortest path query algorithm that calculate the path passing on a TIN)
- Con-Que-AdpM (baseline shortest path query algorithm)
- Con-Que (baseline shortest path query algorithm that calculate the path passing on a point cloud)
- Con-Que-AdpT (baseline shortest path query algorithm that calculate the path passing on a TIN)
